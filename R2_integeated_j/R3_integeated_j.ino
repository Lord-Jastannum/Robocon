...
void pid() {
  ...
  if (jetdata.axis[0] < 125) //left stick horizontal values
  ...
  if (jetdata.axis[3] > 135) //right stick vertical values
    psAxisY = map(jetdata.axis[3], 135, 255, 0, -255);
  else if (jetdata.axis[3] < 120)
    psAxisY = map(jetdata.axis[3], 125, 0, 0, 255);
  else
    psAxisY = 0;
